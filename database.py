...
cursor.execute('INSERT INTO public."Subscription" ("Comics ID", "Price (rub)", "Payment date", "Reader ID", "Payment ID") VALUES (%s, %s, %s, %s, %s);',
...
chapter_id = generate_id(cursor, 'Chapter')
...
cursor.execute('INSERT INTO public."Collection ID" ("Reader ID", "Collection ID", "Name") VALUES (%s, %s, %s);',
